...
var owm_url = URL(string: "https://api.openweathermap.org/data/2.5/onecall?lat=33.441792&lon=-94.037689&appid=237a2971d5e68747c681fc1e13bfe6d3")!
...
AFrequest().openweathermap(completition: { weather in
    for hourly in weather.indices {
        print(weather[hourly].forecast)
    }
})
